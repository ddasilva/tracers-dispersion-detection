"""Helper script to download OMNI data from CdaWeb

Copied from
https://github.com/ddasilva/dmsp-dispersion-detection/blob/main/download_omniweb.py
"""
...
while cur_date <= end_date:
    ...
    url = (
        f"https://spdf.gsfc.nasa.gov/pub/data/omni/omni_cdaweb/hro_1min/{year}/{fname} "
    )
